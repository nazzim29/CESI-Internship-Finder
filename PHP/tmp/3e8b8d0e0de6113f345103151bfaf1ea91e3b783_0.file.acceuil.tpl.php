<?php
/* Smarty version 3.1.39, created on 2021-03-24 14:49:06
  from 'C:\Users\Pedagogie\Desktop\gg\CESI-Internship-Finder\php\vue\acceuil.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_605b43525d5ec8_49022836',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3e8b8d0e0de6113f345103151bfaf1ea91e3b783' => 
    array (
      0 => 'C:\\Users\\Pedagogie\\Desktop\\gg\\CESI-Internship-Finder\\php\\vue\\acceuil.tpl',
      1 => 1616587844,
      2 => 'file',
    ),
  ),
...
function content_605b43525d5ec8_49022836 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="fr">
...
<head>
    ...
    <link rel="stylesheet" href="fr-FR\assets\CSS\acceuil.css">
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            c0.5,0.8,0.9,1.4,1,1.7h0.1c-0.1-0.7-0.2-2-0.2-3.7v-17.8h3V370z" />
                        ...
                        <path
                            d="M413.4,370h-3.5l-4.2-7.1c-0.4-0.7-0.8-1.2-1.1-1.7s-0.7-0.8-1.1-1.1s-0.8-0.5-1.2-0.6s-0.9-0.2-1.5-0.2h-2.4V370h-3v-25.2
            ...
            c3.3,0,5.9-0.9,7.7-2.7s2.8-4.3,2.8-7.5c0-6.5-3.4-9.7-10.3-9.7H615.7z" />
                        ...
                        <path
                            d="M680.4,370h-3.5l-4.2-7.1c-0.4-0.7-0.8-1.2-1.1-1.7s-0.7-0.8-1.1-1.1s-0.8-0.5-1.2-0.6s-0.9-0.2-1.5-0.2h-2.4V370h-3v-25.2
            h7.5c1.1,0,2.1,0.1,3,0.4s1.7,0.7,2.4,1.3s1.2,1.3,1.6,2.1s0.6,1.8,0.6,2.9c0,0.9-0.1,1.7-0.4,2.4s-0.6,1.4-1.1,2s-1.1,1.1-1.8,1.5
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link text-white" href="#">ACCEUIL<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#banner">A PROPOS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#partenaires">NOS PARTENAIRES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#footer">CONTACTER</a>
                    </li>
...
<<<<<<< HEAD
  ...
  <?php echo '<script'; ?>
 src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js" integrity="sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0" crossorigin="anonymous"><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
 src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.6.0/dist/umd/popper.min.js" integrity="sha384-KsvD1yqQ1/1+IA7gi3P0tyJcT3vR+NdBTt13hSJ2lnve8agRGXTTyNaBYmCR/Nwi" crossorigin="anonymous"><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
 src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.min.js" integrity="sha384-nsg8ua9HAw1y0W1btsyWgBklPnCUAFLuTMS2G72MMONqmOymq585AcH49TLBQObG" crossorigin="anonymous"><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
...
>
  <?php echo '<script'; ?>
 src="./assets/JS/acceuil.js"><?php echo '</script'; ?>
>
=======
    <section id="apropos">
        <br><br>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <h3 style=" padding-left: 15%; padding-right: 15%; margin: 20% 0;">Si vous êtes empathique,
                        ...
                        beaucoup
                        de questions et de trouver autant de réponses, nous aimerions vous avoir avec nous!
                    </h3>
                </div>
            </div>
        </div>
...
>
>>>>>>> e743f1d6c0fec2aa4930870883f1a4ee76b4f517
</body>
